 ...
 * bandwidth.
 *
 * The Cache instance must have exclusive access to the [directory], since the internal data
 * structures may cause corruption or runtime errors if not. It may however be shared amongst
...
internal constructor(
    ...
    internal fun put(response: Response): CacheRequest? {
        ...
        if (requestMethod != "GET") {
            // Don't cache non-GET responses. We're technically allowed to cache HEAD requests and
            // some
     ...
     * building up the necessary in-memory cache information.
     *
    ...
    private class Entry {
         ...
         * Next is the number of HTTP Vary request header lines, followed by those lines.
         *
         ...
         * chain. These certificates are base64-encoded and appear each on their own line. The next
         * line contains the length of the local certificate chain. These certificates are also
            ...
            try {
                ...
                for (i in 0 until length) {
                    ...
                    val certificateBytes =
                        line.decodeBase64()
                            ?: throw IOException("Corrupt certificate in cache entry")
    ...
    companion object {
        ...
        /**
         * Returns the names of the request headers that need to be checked for equality when
         * caching.
         */
        ...
        /**
         * Returns the subset of the headers in this's request that impact the content of this's
         * body.
         */
        fun Response.varyHeaders(): Headers {
            // Use the request headers sent over the network, since that's what the response varies
            // on.
