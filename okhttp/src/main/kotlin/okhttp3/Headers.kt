...
internal constructor(
    ...
    class Builder {
        ...
        internal fun addLenient(line: String) = apply {
            ...
            when {
                ...
                line[0] == ':' -> {
                    // Work around empty header names and header names that start with a colon
                    // (created by old
        ...
        /**
         * Add a header with the specified name and value. Does validation of header names and
         * values.
         */
        fun add(
            name: String,
        ...
        /**
         * Add a header with the specified name and formatted date. Does validation of header names
         * and value.
         */
        fun add(
            name: String,
        ...
        /**
         * Add a header with the specified name and formatted instant. Does validation of header
         * names and value.
         */
        @IgnoreJRERequirement // Only programs that already have Instant will use this.
        fun add(
        ...
        /**
         * Set a field with the specified date. If the field is not found, it is added. If the field
        ...
        /**
         * Set a field with the specified instant. If the field is not found, it is added. If the
    ...
    companion object {
        /**
         * Returns headers for the alternating header names and values. There must be an even number
         * of arguments, and they must alternate between header names and values.
         */
        @JvmStatic
        @JvmName("of")
        ...
        @JvmStatic @JvmName("of") fun Map<String, String>.toHeaders(): Headers = commonToHeaders()
