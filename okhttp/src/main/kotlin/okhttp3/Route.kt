...
class Route(
    ...
    /**
     * Returns true if this route tunnels HTTPS or HTTP/2 through an HTTP proxy. See
     * [RFC 2817, Section 5.2][rfc_2817].
     *
    ...
    /**
     * Returns a string with the URL hostname, socket IP address, and socket port, like one of
     * these:
