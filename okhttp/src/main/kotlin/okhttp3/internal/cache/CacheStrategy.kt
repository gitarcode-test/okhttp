...
internal constructor(
    ...
    class Factory(
        ...
        private fun computeCandidate(): CacheStrategy {
            ...
            // source.
            // This check should be redundant as long as the persistence store is well-behaved and
            // the
            // rules are constant.
        ...
        private fun computeFreshnessLifetime(): Long {
            ...
            if (lastModified != null && cacheResponse.request.url.query == null) {
                ...
                // document
                // should be defaulted to 10% of the document's age at the time it was served.
                // Default
