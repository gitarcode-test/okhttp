 ...
 *
 * [RFC 3492]: https://datatracker.ietf.org/doc/html/rfc3492 [RFC 5890]:
 * https://datatracker.ietf.org/doc/html/rfc5890 [UTS #46]: https://www.unicode.org/reports/tr46/
 */
object Punycode {
     ...
     * integer overflow. This will not return null for labels that fit within the DNS size limits.
     */
     ...
     *
     * @return true if the range of [string] from [pos] to [limit] was valid and decoded
     *   successfully. Otherwise, the decode failed.
     */
