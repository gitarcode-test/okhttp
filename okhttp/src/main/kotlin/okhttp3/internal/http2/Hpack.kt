...
object Hpack {
    ...
    constructor(
        ...
        /**
         * In the scenario where the dynamic table size changes multiple times between transmission
         * of header blocks, we need to keep track of the smallest value in that interval.
         */
            ...
            for (i in 0 until headerBlock.size) {
                ...
                if (staticIndex != null) {
                    ...
                    if (headerNameIndex in 2..7) {
                        ...
                        // empty value, so
                        // it's unnecessary to waste cycles looking at them. This check is built on
                        // the
                        // observation that the header entries we care about are in adjacent pairs,
                        // and we
