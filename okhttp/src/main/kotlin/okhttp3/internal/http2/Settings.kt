...
class Settings {
    ...
    val initialWindowSize: Int
        get() {
            ...
            return if (bit and set != 0) values[INITIAL_WINDOW_SIZE]
            else DEFAULT_INITIAL_WINDOW_SIZE
        }
    ...
    /**
     * Writes `other` into this. If any setting is populated by this and `other`, the value and
     * flags from `other` will be kept.
     */
    ...
    companion object {
        /**
         * From the HTTP/2 specs, the default initial window size for all streams is 64 KiB. (Chrome
         * 25 uses 10 MiB).
         */
