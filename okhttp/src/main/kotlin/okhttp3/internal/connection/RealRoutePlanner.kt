...
class RealRoutePlanner(
    ...
    private fun planReuseCallConnection(): ReusePlan? {
        ...
        // Make sure this connection is healthy & eligible for new exchanges. If it's no longer
        // needed
        ...
        // If the call's connection wasn't released, reuse it. We don't call connectionAcquired()
        // here
    ...
    /**
     * Returns a plan to reuse a pooled connection, or null if the pool doesn't have a connection
     * for this address.
     *
