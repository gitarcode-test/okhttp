...
internal constructor(
     ...
     * socket's enabled cipher suites. If there are no required cipher suites the socket must have
    ...
    companion object {
        ...
        // This is nearly equal to the cipher suites supported in Chrome 72, current as of
        // 2019-02-24.
        ...
        /**
         * A backwards-compatible fallback configuration that works on obsolete client platforms and
         * can connect to obsolete servers. When possible, prefer to upgrade your client platform or
         * server rather than using this configuration.
         */
        @JvmField
        val COMPATIBLE_TLS =
            Builder(true)
