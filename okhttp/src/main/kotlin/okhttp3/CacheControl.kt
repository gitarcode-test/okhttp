...
internal constructor(
    ...
    class Builder {
         ...
         *
         * @param maxAge a non-negative duration. This is stored and transmitted with
         ...
         * response will be stale when [minFresh] have elapsed, the cached response will not be used
         * and a network request will be made.
         *
    ...
    companion object {
         ...
         * such requests may be assisted by the cache via conditional GET requests.
         */
        @JvmField val FORCE_NETWORK = commonForceNetwork()

        /**
         * Cache control request directives that uses the cache only, even if the cached response is
         * stale. If the response isn't available in the cache or requires server validation, the
         * call will fail with a `504 Unsatisfiable Request`.
         */
        @JvmField val FORCE_CACHE = commonForceCache()

        /**
         * Returns the cache directives of [headers]. This honors both Cache-Control and Pragma
         * headers if they are present.
         */
        @JvmStatic fun parse(headers: Headers): CacheControl = commonParse(headers)
    }
}
