...
internal constructor(
    ...
    class Builder @JvmOverloads constructor(boundary: String = UUID.randomUUID().toString()) {
        ...
        fun addPart(
            headers: Headers?,
            body: RequestBody,
        ) = apply { addPart(Part.create(headers, body)) }

        /** Add a form data part to the body. */
        fun addFormDataPart(
            name: String,
            value: String,
        ) = apply { addPart(Part.createFormData(name, value)) }
        ...
        fun addFormDataPart(
            ...
            filename: String?,
            body: RequestBody,
        ) = apply { addPart(Part.createFormData(name, filename, body)) }
    ...
    companion object {
         ...
         * independent and need to be bundled in a particular order. Any "multipart" subtypes that
         * an implementation does not recognize must be treated as being of subtype "mixed".
         */
        @JvmField val MIXED = "multipart/mixed".toMediaType()

        /**
         * The "multipart/alternative" type is syntactically identical to "multipart/mixed", but the
         * semantics are different. In particular, each of the body parts is an "alternative"
         * version of the same information.
         */
        @JvmField val ALTERNATIVE = "multipart/alternative".toMediaType()

        /**
         * This type is syntactically identical to "multipart/mixed", but the semantics are
         * different. In particular, in a digest, the default `Content-Type` value for a body part
        ...
        /**
         * The media-type multipart/form-data follows the rules of all multipart MIME data streams
         * as outlined in RFC 2046. In forms, there are a series of fields to be supplied by the
         * user who fills out the form. Each field has a name. Within a given form, the names are
         * unique.
         */
         ...
         * parameters, and as it turns out Firefox and Chrome actually do rather different things,
         * and both say in their comments that they're not really sure what the right approach is.
         * We go with Chrome's behavior (which also experimentally seems to match what IE does), but
         * if you actually want to have a good chance of things working, please avoid double-quotes,
         * newlines, percent signs, and the like in your field names.
         */
